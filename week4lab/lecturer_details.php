...
<html>
<head>
  <title>week4 Lecturer Details</title>
</head>
<body>
  <p style="text-align:left;"><--
    <br><a href="lecturers_list.php" target="_parent">return</a></p>
    <hr>
<h1><?php echo $lecturers[$key]['name']; ?></h1>
<table border="1" cellpadding="10">
  <tr style="text-align:center;font-family: arial;">
    <td colspan="2"><img src="img/<?php echo $lecturers[$key]['id']; ?>.jpg" width="300"></td>
  </tr>
  <tr>
    <td>Email</td>
