...
if(isset($_GET['isInvalidEmail'])&&$_GET['isInvalidEmail']=="true"){
    ...
    <div class="form-group">
        <form action="account.php" method="post">
            <div class="row">
                ...
                <div>
                    <input class="form-control" id="staffEmail" type="text"  name="email" placeholder="Enter email" required>
                </div>
            </div><br>
            ...
            <div class="row">
                ...
                <div>
                    <input class="form-control" type="password" name="password" id="staffPass" placeholder="Enter passowrd" required>
                </div>
            </div><br>
            <div class="row">
