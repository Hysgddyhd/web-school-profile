    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
          <input name="price" type="text" class="form-control" id="produproductpricectid" placeholder="Product Price" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_price']; ?>" required>
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            ...
            <div class="radio">
              <label>
                <input name="cond" type="radio" id="productcond" value="Used" <?php if(isset($_GET['edit'])) if($editrow['fld_product_condition']=="Used") echo "checked"; ?> required> Used
              </label>
            </div>
          </div>
        </div>
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <select name="year" class="form-control" id="productyear">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9">
            <input name="quantity" type="text" class="form-control" id="productq" placeholder="Product Quantity" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_quantity']; ?>" required>
          </div>
        </div>
        <div class="form-group">
        ...
        <table class="table table-striped table-border">
          <tr>
            ...
            $start_from=($page-1)*$per_page;
              try {
                ...
                $stmt=$conn->prepare("SELECT*FROM tbl_products_a123456 order by fld_product_num desc limit $start_from ,$per_page");
                $stmt->execute();
          ...
          <tr>
            ...
            <td>
              ...
              <a href="products.php?delete=<?php echo $readRow['fld_product_num']; ?>" class="btn btn-danger btn-xs" role="button" onclick="return confirm('Are you sure to delete?');">Delete</a>
            </td>
          </tr>
          <?php
            }
      ...
      <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2" >
        <nav>
          <ul class="pagination">
            ...
            ?>
            <?php if ($page==1) { ?>
              <li class="disabled"><span aria-hidden="true">«</li>
            <?php }else{ ?>
              <li ><a href="products.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li> 
            <?php  } for ($i=1; $i <=$total_pages ; $i++) { 
              if($page==$i){?>
              <li class="active"><a href="products.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
            <?php } else{ ?>
